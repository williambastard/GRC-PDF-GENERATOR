...
</html>`, `S:\\CRM-API\\public\\views\\layouts\\pdf\\invoices.base.html`);
...
<body>
\t`);
                outputBuffer.echo(await this.traceableRenderBlock(12, this.source)('invoices', context.clone(), outputBuffer, blocks));
                outputBuffer.echo(`
\t`);
